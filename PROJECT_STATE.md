...
OpenAI Cost Guard A — correlation revision idempotency: **implemented / awaiting Architect review** on `hotfix/openai-cost-guard-a` (not deployed). Exact production parent `99658a6f893483317dcecaf15d886cd1ed8d692b`. Temporal Signals A `a9dc8c9c9e74dc4b8857fface89e803f493d21fd` is **not merged**. No Alembic migration. Flutter untouched. User assistant model unchanged. Background correlation is signature-idempotent and uses LOW/LOW reasoning independent of interactive Assistant settings.
