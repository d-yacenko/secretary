...
Voice Assistant A: **CODE ACCEPTED / DEPLOYED / AWAITING USER MANUAL ACCEPTANCE** on `review/voice-assistant-a`. Accepted / exact deployed application SHA `5ef2a2db117dc5a1c0ac54bad3d0e897ebcf6357` (R2-R1 parent `44161b01b8b065204de0f5025fc55b96910f6058`; R2 application `244cdd28b81e7d8b33b6f78938fa062c03a82b3a`; R1 application `89c7e0bf9fc74dbfcc8a02f9a6795b4f3deae82e`). Previous production SHA `eb3af922f804e6faf1d895fd14c0973981ce515e`. **R3 is not CODE ACCEPTED.** **R4 is not CODE ACCEPTED.** **R4-R1 is not CODE ACCEPTED** (`e097069dad8bcb0066e531a63f5f668e786e62ab`). **R4-R2 is not CODE ACCEPTED** (`f8c9a256af9d07b77b088e94fc1110e69479343f`). **R4-R3 (Android recorder truncation / audio-session corrective) is implemented / awaiting Architect review and user physical gates, not CODE ACCEPTED**, application SHA `d121cf90e351612275663c6845a76e9dd80ed587` (parent `5d3e173d9c5ba9cd99927f2ecdcaf3fa3151f3d5`; rejected R4 `a4bb618c69ff170f223bef13dd5303d8b5961b67`; R3-R1 base `f20c0e4bcc55bbb9e6a4b79cf052d17f8daf637b`; R3 `fe496d23358fc3bd0b0cd407fc72258ceeec0022` was not accepted after user-manual Volume Up / Learn failure; R3 docs tip `03cb692d0a032f2e069d3f5718dcc95bfeb41f03`). Media cues no longer overlap microphone capture; native STREAM_MUSIC stop deferred until after recorder stop; 500 ms WAV floor remains defensive. Backend taxonomy split (not deployed): short/malformed WAV vs empty transcript vs generic provider 400. R4-R2 output policy preserved. No DB migration. Production was not mutated. R1 PASS. R2 marker architecture/semantics PASS. R2-R1 reference hygiene PASS. Linux user physical launch + Voice PASS. Android transcription physical gate remains user-run after this APK. Not PRODUCTION ACCEPTED. Encrypted Architect context untouched. Alembic **0040 / 0040** (no Voice A/R2/R3/R4/R4-R1/R4-R2/R4-R3 migration; no `0041`). Detached VDS deploy of the accepted application SHA rebuilt `api`/`worker` only; PostgreSQL volume `db_data` was not recreated. Pre-deploy backup `/opt/secretary/backups/pre-voice-a-20260914T075123Z-eb3af922.dump`. Documented TTS/STT defaults appended to production `.env` (`OPENAI_TTS_MODEL=gpt-4o-mini-tts`, `OPENAI_TTS_VOICE=alloy`, `OPENAI_TRANSCRIPTION_MODEL=gpt-4o-mini-transcribe`); existing per-user OpenAI credential path unchanged. FAILED `1435` → `1435`. Internal and public `/health` 200. Authenticated `/assistant/speech` smoke: HTTP 200, `audio/mpeg`, 16896 bytes, objects/representations unchanged. Android debug APK minSdk **23**. Linux plugin RUNPATH rewritten to `$ORIGIN` in R4-R1; this corrective does not change Linux native linkage. No Voice B.
