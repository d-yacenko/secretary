...
Temporal Signals A integration onto Cost Guard C lineage: **implemented / awaiting Architect review** at `4bf706ac5ce57efd68fae803345af7cfddeece58` on `review/temporal-signals-a-integration` (exact parent `bd6ebebc4d6475e45b8b7a91f3da253890d75ae2`; accepted Temporal source head `a9dc8c9c9e74dc4b8857fface89e803f493d21fd`; Temporal source base `99658a6f893483317dcecaf15d886cd1ed8d692b`). Alembic **0037 → 0036** (`user_settings.temporal_signals_enabled`). Lineage: 0035 Cost Guard B / `objects.embedding_signature`; 0036 Cost Guard C / `openai_daily_token_limit`; 0037 Temporal Signals / `temporal_signals_enabled`. Default `temporal_signals_enabled=false`. No automatic enable. No historical backfill. No deploy. Cost Guards A+B+C remain intact. Production application remains `7b580d955085ae7a5b3ae8c0a80b7f580cb938b1`. Production Alembic remains **0036 / 0036**.
