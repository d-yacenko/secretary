...
Voice Assistant A R2: **implemented / awaiting Architect review** on `review/voice-assistant-a`. Application SHA `244cdd28b81e7d8b33b6f78938fa062c03a82b3a` (parent `bbcef9a109f8c6ce73048cd87e8e5b3adfaa41d2`; R1 application `89c7e0bf9fc74dbfcc8a02f9a6795b4f3deae82e`). Canonical base `54f14a86b4c6de3c29b2f14c8a8a14b4db5ddf8c`. Inherited accepted application SHA `7ae954aa186ee211e6640753e384de6e1c75a93d`. R1 review PASS. Overall Voice Assistant A is **not CODE ACCEPTED**. Not deployed. Encrypted Architect context untouched. R2 exposes the persisted Inbox «Просмотрено досюда» frontier to the ordinary Assistant toolset: `list_inbox_since_review_marker` (READ, strictly newer than the inclusive anchor), `set_inbox_review_marker` / `clear_inbox_review_marker` (ANNOTATE, immediate, no Pending Action Plan, no provider read-state write). No migration. No Voice B. No deploy.
