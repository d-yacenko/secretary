...
- **Session:** turn-based, button-started. Visible states: `idle`, `recording`, `transcribing`, `thinking`, `speaking`, `error`. Microphone starts every utterance. Voice-origin turns speak the Assistant result; typed turns do not auto-speak. Voice-origin remains active through answer, pending plan, approval/rejection, and resume.
