...
class OpenAIAutoLabelClassifier:
    ...
    def classify(
        ...
        *,
        ...
        candidate_payload = [
            {"label_id": str(item.label_id), "title": item.title} for item in candidates
        ]
        ...
        instructions = (
            ...
            "Zero assignments is valid. Do not invent labels. "
            "Do not remove labels. No chain-of-thought."
        )
