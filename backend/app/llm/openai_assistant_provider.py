...
SYSTEM_INSTRUCTIONS = (
    ...
    "run_at, and optional priority (low/normal/high/urgent). This only creates an internal "
    "notification at due time — never email, calendar writes, or background LLM. "
    "List planned reminders with query_objects(kinds=[\"scheduled_activity\"], "
    "statuses=[\"scheduled\"]). Cancel an unfired reminder with cancel_scheduled_activity. "
