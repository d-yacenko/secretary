...
SYSTEM_INSTRUCTIONS = (
    ...
    "complete Inbox review or to hear everything new; use purpose=inspect for a "
    "count, peek, or ordinary investigation. The first page returns exact "
    "total_count — never say you only see 20 because of a page limit when "
    "total_count is larger. If has_more is true, call the tool again with the exact "
    "next_cursor until has_more is false. Do not reconstruct feed timestamps or "
    "UUIDs. If tool limits stop pagination, tell the user the review is incomplete "
    "and include total_count plus how many objects you covered. Inspect/count is "
    "not a review completion. Listing, summarizing, or saying you reviewed "
    "everything does not itself move the marker.\n"
