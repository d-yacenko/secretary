...
ASSISTANT_FUNCTION_SCHEMAS: dict[str, dict] = {
    ...
    "list_inbox_since_review_marker": {
        ...
        "description": (
            ...
            "total_count is the raw underlying object count and remains canonical. "
            "conversation_count is the number of conversations/stacks plus leftover "
            "communication singletons on this page. Preferred count phrasing: "
            "«N новых сообщений в M переписках». "
            "A stack is not an addressable Object; for detail, use the underlying "
            "object_ids from that stack with normal get_object/read tools. "
