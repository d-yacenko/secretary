...
Read `PROJECT_STATE.md` and `CURRENT_TASK.md` at the start of each work cycle.

Do not read the full build playbook. Read only the current `PHASE NN` section from `personal_secretary_llm_build_playbook.md`.
